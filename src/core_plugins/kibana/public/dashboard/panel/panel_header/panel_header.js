...
export function PanelHeader(_a) {
    var title = _a.title, panelId = _a.panelId, embeddable = _a.embeddable, isViewOnlyMode = _a.isViewOnlyMode, hidePanelTitles = _a.hidePanelTitles;
    ...
    return (React.createElement("div", { className: "dshPanel__header", "data-test-subj": "dashboardPanelHeading-" + (title || '').replace(/\s/g, '') },
        React.createElement("span", { "data-test-subj": "dashboardPanelTitle", className: "dshPanel__title", title: title, "aria-label": "Dashboard panel: " + title }, hidePanelTitles ? '' : title),
        React.createElement("div", { className: "dshPanel__headerButtonGroup" },
            React.createElement(PanelOptionsMenuContainer, { panelId: panelId, embeddable: embeddable }))));
}
