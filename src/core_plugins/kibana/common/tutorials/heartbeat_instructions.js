...
**Run As Administrator**). If you are running Windows XP, you might need to download and install PowerShell.\n\
 5. From the PowerShell prompt, run the following commands to install Heartbeat as a Windows service.',
      ...
      commands: ['PS > cd C:\\Program Files\\Heartbeat', 'PS C:\\Program Files\\Heartbeat> .\\install-service-heartbeat.ps1']
    }
  },
  START: {
    OSX: {
    ...
    WINDOWS: {
      ...
      commands: ['PS C:\\Program Files\\Heartbeat> .\\heartbeat.exe setup', 'PS C:\\Program Files\\Heartbeat> Start-Service heartbeat']
    }
  },
  CONFIG: {
    OSX: {
