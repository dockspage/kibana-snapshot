...
function osqueryLogsSpecProvider(server, context) {
  ...
  return {
    id: 'osqueryLogs',
    name: _i18n.i18n.translate('kbn.server.tutorials.osqueryLogs.nameTitle', {
      defaultMessage: 'Osquery logs'
    }),
    category: _tutorial_category.TUTORIAL_CATEGORY.SECURITY,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.osqueryLogs.shortDescription', {
      defaultMessage: 'Collect the result logs created by osqueryd.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.osqueryLogs.longDescription', {
...
[Learn more]({learnMoreLink}).',
    ...
    artifacts: {
      dashboards: [{
        ...
        linkLabel: _i18n.i18n.translate('kbn.server.tutorials.osqueryLogs.artifacts.dashboards.linkLabel', {
