...
function postgresqlLogsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `postgresql` Filebeat module parses error and slow logs created by PostgreSQL.' + ' [Learn more]({config.docs.beats.filebeat}/filebeat-module-postgresql.html).',
