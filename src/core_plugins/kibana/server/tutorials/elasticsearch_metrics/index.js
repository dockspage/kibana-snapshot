...
function elasticsearchMetricsSpecProvider(server, context) {
  const moduleName = 'elasticsearch';
  return {
    id: 'elasticsearchMetrics',
    name: _i18n.i18n.translate('kbn.server.tutorials.elasticsearchMetrics.nameTitle', {
      defaultMessage: 'Elasticsearch metrics'
    }),
    isBeta: true,
    category: _tutorial_category.TUTORIAL_CATEGORY.METRICS,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.elasticsearchMetrics.shortDescription', {
      defaultMessage: 'Fetch internal metrics from Elasticsearch.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.elasticsearchMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
    ...
    artifacts: {
      application: {
        label: _i18n.i18n.translate('kbn.server.tutorials.elasticsearchMetrics.artifacts.application.label', {
