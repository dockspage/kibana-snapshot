...
function traefikLogsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `traefik` Filebeat module parses access logs created by Traefik.' + ' [Learn more]({config.docs.beats.filebeat}/filebeat-module-traefik.html).',
