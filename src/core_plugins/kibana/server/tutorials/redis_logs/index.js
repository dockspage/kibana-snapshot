...
function redisLogsSpecProvider(server, context) {
  ...
  return {
    id: 'redisLogs',
    name: _i18n.i18n.translate('kbn.server.tutorials.redisLogs.nameTitle', {
      defaultMessage: 'Redis logs'
    }),
    category: _tutorial_category.TUTORIAL_CATEGORY.LOGGING,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.redisLogs.shortDescription', {
      defaultMessage: 'Collect and parse error and slow logs created by Redis.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.redisLogs.longDescription', {
...
[Learn more]({learnMoreLink}).',
    ...
    artifacts: {
      dashboards: [{
        ...
        linkLabel: _i18n.i18n.translate('kbn.server.tutorials.redisLogs.artifacts.dashboards.linkLabel', {
