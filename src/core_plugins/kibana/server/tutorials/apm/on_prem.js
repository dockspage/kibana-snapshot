  ...
  return {
    instructionSets: [{
      ...
      instructionVariants: [{
        ...
        instructions: (0, _apm_client_instructions.createJavaClientInstructions)()
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.JS,
        instructions: (0, _apm_client_instructions.createJsClientInstructions)()
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.NODE,
        instructions: (0, _apm_client_instructions.createNodeClientInstructions)()
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.DJANGO,
        instructions: (0, _apm_client_instructions.createDjangoClientInstructions)()
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.FLASK,
        instructions: (0, _apm_client_instructions.createFlaskClientInstructions)()
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.RAILS,
        instructions: (0, _apm_client_instructions.createRailsClientInstructions)()
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.RACK,
        instructions: (0, _apm_client_instructions.createRackClientInstructions)()
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.GO,
        instructions: (0, _apm_client_instructions.createGoClientInstructions)()
      }],
      statusCheck: {
