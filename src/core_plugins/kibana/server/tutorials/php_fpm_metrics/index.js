...
function phpfpmMetricsSpecProvider(server, context) {
  const moduleName = 'php_fpm';
  return {
    id: 'phpfpmMetrics',
    name: _i18n.i18n.translate('kbn.server.tutorials.phpFpmMetrics.nameTitle', {
      defaultMessage: 'PHP-FPM metrics'
    }),
    category: _tutorial_category.TUTORIAL_CATEGORY.METRICS,
    isBeta: true,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.phpFpmMetrics.shortDescription', {
      defaultMessage: 'Fetch internal metrics from PHP-FPM.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.phpFpmMetrics.longDescription', {
