...
function postgresqlMetricsSpecProvider(server, context) {
  const moduleName = 'postgresql';
  return {
    id: 'postgresqlMetrics',
    name: _i18n.i18n.translate('kbn.server.tutorials.postgresqlMetrics.nameTitle', {
      defaultMessage: 'PostgreSQL metrics'
    }),
    category: _tutorial_category.TUTORIAL_CATEGORY.METRICS,
    isBeta: true,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.postgresqlMetrics.shortDescription', {
      defaultMessage: 'Fetch internal metrics from PostgreSQL.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.postgresqlMetrics.longDescription', {
