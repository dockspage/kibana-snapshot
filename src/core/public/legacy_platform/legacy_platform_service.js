...
var LegacyPlatformService = /** @class */ (function () {
    ...
    LegacyPlatformService.prototype.start = function (_a) {
        var injectedMetadata = _a.injectedMetadata, fatalErrors = _a.fatalErrors, notifications = _a.notifications, loadingCount = _a.loadingCount, basePath = _a.basePath, uiSettings = _a.uiSettings, chrome = _a.chrome;
