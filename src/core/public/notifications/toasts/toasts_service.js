...
var ToastsService = /** @class */ (function () {
    ...
    ToastsService.prototype.start = function () {
        var toasts = new ToastsStartContract();
        render(React.createElement(GlobalToastList, { dismissToast: function (toast) { return toasts.remove(toast); }, "toasts$": toasts.get$() }), this.params.targetDomElement);
        return toasts;
    };
