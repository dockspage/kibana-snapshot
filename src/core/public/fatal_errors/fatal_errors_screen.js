        ...
        return (React.createElement(EuiPage, { style: { minHeight: '100vh' } },
            React.createElement(EuiPageBody, null,
                React.createElement(EuiPageContent, { verticalPosition: "center", horizontalPosition: "center" },
                    React.createElement(EuiEmptyPrompt, { iconType: "alert", iconColor: "danger", title: React.createElement("h2", null, "Something went wrong"), body: React.createElement("p", null, "Try refreshing the page. If that doesn't work, go back to the previous page or clear your session data."), actions: [
                            React.createElement(EuiButton, { color: "primary", fill: true, onClick: this.onClickClearSession, "data-test-subj": "clearSession" }, "Clear your session"),
                            React.createElement(EuiButtonEmpty, { onClick: this.onClickGoBack, "data-test-subj": "goBack" }, "Go back"),
                        ] }),
