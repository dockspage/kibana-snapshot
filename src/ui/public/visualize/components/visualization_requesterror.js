...
var VisualizationRequestError = /** @class */ (function (_super) {
    ...
    VisualizationRequestError.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "visualize-error visualize-chart", ref: this.containerDiv },
            React.createElement(EuiText, { className: "visualize-request-error", color: "danger", size: "xs" }, errorMessage)));
    };
