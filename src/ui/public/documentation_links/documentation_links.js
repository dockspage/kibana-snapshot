...
export var DOC_LINK_VERSION = metadata.branch;
export var ELASTIC_WEBSITE_URL = 'https://www.elastic.co/';
var ELASTIC_DOCS = ELASTIC_WEBSITE_URL + "guide/en/elasticsearch/reference/" + DOC_LINK_VERSION + "/";
