...
var SuggestionsComponent = /** @class */ (function (_super) {
    ...
    SuggestionsComponent.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "reactSuggestionTypeahead" },
            React.createElement("div", { className: "typeahead" },
                React.createElement("div", { className: "typeahead-popover" },
                    React.createElement("div", { id: "typeahead-items", className: "typeahead-items", role: "listbox", ref: function (node) { return (_this.parentNode = node); }, onScroll: this.handleScroll }, suggestions)))));
    };
