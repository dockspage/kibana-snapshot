...
var UrlPanelContent = /** @class */ (function (_super) {
    tslib_1.__extends(UrlPanelContent, _super);
    function UrlPanelContent(props) {
                    ...
                    case 3:
                        ...
                        if (this.mounted) {
                            ...
                            this.setState({
                                useShortUrl: false,
                                isCreatingShortUrl: false,
                                shortUrlErrorMsg: "Unable to create short URL. Error: " + fetchError_1.message,
                            }, this.setUrl);
                        }
                        return [3 /*break*/, 4];
        ...
        _this.renderExportUrlAsOptions = function () {
            ...
            return [
                (_a = {
                        ...
                        label: _this.renderWithIconTip('Snapshot', "Snapshot URLs encode the current state of the " + _this.props.objectType + " in the URL itself.\n            Edits to the saved " + _this.props.objectType + " won't be visible via this URL.")
                    },
                ...
                (_b = {
                        ...
                        label: _this.renderWithIconTip('Saved object', "You can share this URL with people to let them load the most recent saved version of this " + _this.props.objectType + ".")
                    },
        ...
        _this.renderExportAsRadioGroup = function () {
            var generateLinkAsHelp = _this.isNotSaved()
                ? "Can't share as saved object until the " + _this.props.objectType + " has been saved."
                : undefined;
            return (React.createElement(EuiFormRow, { label: "Generate the link as", helpText: generateLinkAsHelp },
    ...
    UrlPanelContent.prototype.componentWillUnmount = function () {
        window.removeEventListener('hashchange', this.resetUrl);
        this.mounted = false;
    };
    UrlPanelContent.prototype.componentDidMount = function () {
        this.mounted = true;
        this.setUrl();
        window.addEventListener('hashchange', this.resetUrl, false);
    };
    UrlPanelContent.prototype.render = function () {
        var _this = this;
        return (React.createElement(EuiForm, { className: "sharePanelContent", "data-test-subj": "shareUrlForm" },
            ...
            React.createElement(EuiCopy, { textToCopy: this.state.url, anchorClassName: "sharePanel__copyAnchor" }, function (copy) { return (React.createElement(EuiFormRow, null,
                React.createElement(EuiButton, { fill: true, onClick: copy, disabled: _this.state.isCreatingShortUrl || _this.state.url === '', "data-share-url": _this.state.url, "data-test-subj": "copyShareUrlButton", size: "s" },
                    "Copy ",
                    _this.props.isEmbedded ? 'iFrame code' : 'link'))); })));
    };
    return UrlPanelContent;
}(Component));
export { UrlPanelContent };
